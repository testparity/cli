...
| S008-SC-007 | In table mode, each aggregate summary status **MUST** agree with the corresponding evaluated rule results and **MUST NOT** report `FAIL` when all rules of that type passed. |
